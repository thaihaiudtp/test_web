    ...
    return (
        <div className="font-[sans-serif] max-w-7xl mx-auto h-screen">
            <div className="grid md:grid-cols-2 items-center gap-8 h-full">
                ...
                <p className="text-sm mt-8 text-center text-gray-800">Dont have an account? <a href="/signup" className="text-blue-600 font-semibold tracking-wide hover:underline ml-1">Register here</a></p>
                </form>
